...
#define	SHT_ARM_ATTRIBUTES	0x70000003	/* Object file compatibilityattributes. */
...
#define	DT_INIT_ARRAY	25	/* Address of the array of pointers toinitialization functions */
